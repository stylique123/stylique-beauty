...
function X_() {
  ...
  function Ht(_, P, Ie, Pe, vt) {
    ...
    else if (ht = pe(_), typeof ht == "function") for (_ = ht.call(_), ct = 0; !(st = _.next()).done; ) st = st.value, ht = Pe + Ne(st, ct++), ut += Ht(st, P, Ie, ht, vt);
...
function K_() {
  return JR || (JR = 1, function(Y, q) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      var A = "18.3.1", et = Symbol.for("react.element"), Qe = Symbol.for("react.portal"), Oe = Symbol.for("react.fragment"), S = Symbol.for("react.strict_mode"), Ke = Symbol.for("react.profiler"), te = Symbol.for("react.provider"), Z = Symbol.for("react.context"), Te = Symbol.for("react.forward_ref"), J = Symbol.for("react.suspense"), pe = Symbol.for("react.suspense_list"), G = Symbol.for("react.memo"), xe = Symbol.for("react.lazy"), Ve = Symbol.for("react.offscreen"), it = Symbol.iterator, lt = "@@iterator";
      function pt(h) {
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, ee), ee.default;
      ...
      function B(h) {
        return !!(typeof h == "string" || typeof h == "function" || h === Oe || h === Ke || Ht || h === S || h === J || h === pe || Ne || h === Ve || en || on || kt || typeof h == "object" && h !== null && (h.$$typeof === xe || h.$$typeof === G || h.$$typeof === te || h.$$typeof === Z || h.$$typeof === Te || // This needs to include all possible module reference object
...
function Z_() {
  ...
  function S(Ke, te, Z) {
    var Te, J = {}, pe = null, G = null;
    Z !== void 0 && (pe = "" + Z), te.key !== void 0 && (pe = "" + te.key), te.ref !== void 0 && (G = te.ref);
    ...
    return { $$typeof: q, type: Ke, key: pe, ref: G, props: J, _owner: Qe.current };
  }
...
function ek() {
  return eT || (eT = 1, process.env.NODE_ENV !== "production" && function() {
    var Y = Lt, q = Symbol.for("react.element"), A = Symbol.for("react.portal"), et = Symbol.for("react.fragment"), Qe = Symbol.for("react.strict_mode"), Oe = Symbol.for("react.profiler"), S = Symbol.for("react.provider"), Ke = Symbol.for("react.context"), te = Symbol.for("react.forward_ref"), Z = Symbol.for("react.suspense"), Te = Symbol.for("react.suspense_list"), J = Symbol.for("react.memo"), pe = Symbol.for("react.lazy"), G = Symbol.for("react.offscreen"), xe = Symbol.iterator, Ve = "@@iterator";
    function it(R) {
    ...
    function Ye(R, B, ue) {
      {
        var me = lt.ReactDebugCurrentFrame, nt = me.getStackAddendum();
    ...
    function en(R) {
      return !!(typeof R == "string" || typeof R == "function" || R === et || R === Oe || un || R === Qe || R === Z || R === Te || He || R === G || Je || ke || tt || typeof R == "object" && R !== null && (R.$$typeof === pe || R.$$typeof === J || R.$$typeof === S || R.$$typeof === Ke || R.$$typeof === te || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
      ...
      if (typeof R == "object")
        switch (R.$$typeof) {
          ...
          case J:
            ...
            return me !== null ? me : Ne(R.type) || "Memo";
          case pe: {
...
` + ut + R;
    ...
    function br(R, B) {
      ...
      try {
        ...
        if (rt && me && typeof rt.stack == "string") {
...
` + mt[rn].replace(" at new ", " at ");
    ...
    function Bn(R, B, ue) {
      ...
      if (typeof R == "object")
        switch (R.$$typeof) {
          ...
          case pe: {
            var me = R, nt = me._payload, qe = me._init;
            try {
          ...
          if (qe(R, gt)) {
            ...
            try {
              if (typeof R[gt] != "function") {
                var xn = Error((me || "React class") + ": " + ue + " type `" + gt + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof R[gt] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw xn.name = "Invariant Violation", xn;
              }
              mt = R[gt](B, gt, me, ue, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (rn) {
              mt = rn;
            }
            mt && !(mt instanceof Error) && (sa(nt), pt("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", me || "React class", ue, gt, typeof mt), sa(null)), mt instanceof Error && !(mt.message in Yr) && (Yr[mt.message] = !0, sa(nt), pt("Failed %s type: %s", ue, mt.message), sa(null));
          }
      }
    }
    ...
    var sn = function(R, B, ue, me, nt, qe, gt) {
      var mt = {
        // This tag allows us to uniquely identify this as a React Element
        $$typeof: q,
        // Built-in properties that belong on the element
    ...
    function Kn(R, B, ue, me, nt) {
      {
        ...
        return sn(R, mt, xn, nt, me, ca.current, gt);
      }
    }
    ...
    function pl(R, B) {
      {
        ...
        Zl[ue] = !0;
        var me = "";
        R && R._owner && R._owner !== nn.current && (me = " It was passed a child from " + Ne(R._owner.type) + "."), Wt(R), pt('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', ue, me), Wt(null);
      }
    }
    function vl(R, B) {
      {
    ...
    function _r(R) {
      {
        for (var B = Object.keys(R.props), ue = 0; ue < B.length; ue++) {
          ...
          if (me !== "children" && me !== "key") {
            Wt(R), pt("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", me), Wt(null);
            break;
          }
        }
...
var ye = pE.exports, hE = { exports: {} }, Ia = {}, Wm = { exports: {} }, cE = {};
/**
 * @license React
...
function tk() {
  return tT || (tT = 1, function(Y) {
    ...
    var te = [], Z = [], Te = 1, J = null, pe = 3, G = !1, xe = !1, Ve = !1, it = typeof setTimeout == "function" ? setTimeout : null, lt = typeof clearTimeout == "function" ? clearTimeout : null, pt = typeof setImmediate < "u" ? setImmediate : null;
...
function nk() {
  return nT || (nT = 1, function(Y) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      var Wa = sa, fi = null;
      Y.unstable_IdlePriority = G, Y.unstable_ImmediatePriority = Z, Y.unstable_LowPriority = pe, Y.unstable_NormalPriority = J, Y.unstable_Profiling = fi, Y.unstable_UserBlockingPriority = Te, Y.unstable_cancelCallback = Ln, Y.unstable_continueExecution = ht, Y.unstable_forceFrameRate = Xn, Y.unstable_getCurrentPriorityLevel = br, Y.unstable_getFirstCallbackNode = $t, Y.unstable_next = vt, Y.unstable_pauseExecution = ct, Y.unstable_requestPaint = Wa, Y.unstable_runWithPriority = Pe, Y.unstable_scheduleCallback = ut, Y.unstable_shouldYield = ci, Y.unstable_wrapCallback = st, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(fE)), fE;
}
var rT;
...
function rk() {
  ...
  function Ye(n, r, l, o) {
    ...
    (c !== null ? c.type !== 0 : o || !(2 < r.length) || r[0] !== "o" && r[0] !== "O" || r[1] !== "n" && r[1] !== "N") && (xe(r, l, c, o) && (l = null), o || c === null ? pe(r) && (l === null ? n.removeAttribute(r) : n.setAttribute(r, "" + l)) : c.mustUseProperty ? n[c.propertyName] = l === null ? c.type === 3 ? !1 : "" : l : (r = c.attributeName, o = c.attributeNamespace, l === null ? n.removeAttribute(r) : (c = c.type, l = c === 3 || c === 4 && l === !0 ? "" : "" + l, o ? n.setAttributeNS(o, r, l) : n.setAttribute(r, l))));
  }
    ...
    tu(function() {
      ...
      e: {
        ...
        if ($ !== void 0) {
          ...
          0 < Ce.length && ($ = new fe($, ge, null, l, W), X.push({ event: $, listeners: Ce }));
        }
      }
      if (!(r & 7)) {
        e: {
          if ($ = n === "mouseover" || n === "pointerover", fe = n === "mouseout" || n === "pointerout", $ && l !== nn && (ge = l.relatedTarget || l.fromElement) && (vu(ge) || ge[Wi])) break e;
          if ((fe || $) && ($ = W.window === W ? W : ($ = W.ownerDocument) ? $.defaultView || $.parentWindow : window, fe ? (ge = l.relatedTarget || l.toElement, fe = z, ge = ge ? vu(ge) : null, ge !== null && (Dn = nt(ge), ge !== Dn || ge.tag !== 5 && ge.tag !== 6) && (ge = null)) : (fe = null, ge = z), fe !== ge)) {
            if (Ce = Rl, Q = "onMouseLeave", k = "onMouseEnter", w = "mouse", (n === "pointerout" || n === "pointerover") && (Ce = av, Q = "onPointerLeave", k = "onPointerEnter", w = "pointer"), Dn = fe == null ? $ : ni(fe), L = ge == null ? $ : ni(ge), $ = new Ce(Q, w + "leave", fe, l, W), $.target = Dn, $.relatedTarget = L, Q = null, vu(W) === z && (Ce = new Ce(k, w + "enter", ge, l, W), Ce.target = L, Ce.relatedTarget = Dn, Q = Ce), Dn = Q, fe && ge) t: {
              for (Ce = fe, k = ge, w = 0, L = Ce; L; L = xl(L)) w++;
            ...
            fe !== null && wv(X, $, fe, Ce, !1), ge !== null && Dn !== null && wv(X, Dn, ge, Ce, !0);
          }
        }
        e: {
          if ($ = z ? ni(z) : window, fe = $.nodeName && $.nodeName.toLowerCase(), fe === "select" || fe === "input" && $.type === "file") var Se = Km;
          else if (fv($)) if (pv) Se = gv;
          else {
            Se = yv;
            var Ae = Jm;
          }
          else (fe = $.nodeName) && fe.toLowerCase() === "input" && ($.type === "checkbox" || $.type === "radio") && (Se = Zm);
          if (Se && (Se = Se(n, z))) {
            rd(X, Se, l, W);
            break e;
          }
...
`).replace(ay, "");
  ...
  function yu(n) {
    ...
    function fe(k, w, L, Q, Se) {
      ...
      if (typeof Q == "object" && Q !== null) {
        switch (Q.$$typeof) {
          ...
          case Mt:
            var Ae = Q._init;
            return fe(k, w, L, Ae(Q._payload), Se);
        }
    ...
    function ge(k, w, L, Q) {
      ...
      for (Fe = o(k, Fe); We < L.length; We++) tr = fe(Fe, k, We, L[We], Q), tr !== null && (n && tr.alternate !== null && Fe.delete(tr.key === null ? We : tr.key), w = d(tr, w, We), Ae === null ? Se = tr : Ae.sibling = tr, Ae = tr);
    ...
    function Ce(k, w, L, Q) {
      ...
      for (Fe = o(k, Fe); !At.done; We++, At = L.next()) At = fe(Fe, k, We, At.value, Q), At !== null && (n && At.alternate !== null && Fe.delete(At.key === null ? We : At.key), w = d(At, w, We), Ae === null ? Se = At : Ae.sibling = At, Ae = At);
  ...
  function cs(n, r, l, o) {
    ...
    if (d !== null) {
      ...
      do {
        ...
        if ((o & $) === $) {
          ...
          e: {
            ...
            switch ($ = r, fe = l, Ce.tag) {
              ...
              case 0:
                if (ge = Ce.payload, $ = typeof ge == "function" ? ge.call(fe, X, $) : ge, $ == null) break e;
                X = ie({}, X, $);
                break e;
              case 2:
                ma = !0;
        ...
        } else fe = { eventTime: fe, lane: $, tag: E.tag, payload: E.payload, callback: E.callback, next: null }, W === null ? (z = W = fe, T = X) : W = W.next = fe, m |= $;
        if (E = E.next, E === null) {
...
` + d.stack;
  ...
  function Iv(n, r, l, o, c) {
    ...
    if (gn(r, c), r.stateNode === null) za(n, r), Kc(r, l, o), Rs(r, l, o, c), o = !0;
      ...
      (W = typeof fe == "function" || typeof m.getSnapshotBeforeUpdate == "function") || typeof m.UNSAFE_componentWillReceiveProps != "function" && typeof m.componentWillReceiveProps != "function" || (E !== X || $ !== T) && Hv(r, m, o, T), ma = !1, $ = r.memoizedState, m.state = $, cs(r, o, m, c);
      var ge = r.memoizedState;
      E !== X || $ !== ge || Wn.current || ma ? (typeof fe == "function" && (kd(r, l, fe, o), ge = r.memoizedState), (z = ma || Fv(r, l, z, o, $, ge, T) || !1) ? (W || typeof m.UNSAFE_componentWillUpdate != "function" && typeof m.componentWillUpdate != "function" || (typeof m.componentWillUpdate == "function" && m.componentWillUpdate(o, ge, T), typeof m.UNSAFE_componentWillUpdate == "function" && m.UNSAFE_componentWillUpdate(o, ge, T)), typeof m.componentDidUpdate == "function" && (r.flags |= 4), typeof m.getSnapshotBeforeUpdate == "function" && (r.flags |= 1024)) : (typeof m.componentDidUpdate != "function" || E === n.memoizedProps && $ === n.memoizedState || (r.flags |= 4), typeof m.getSnapshotBeforeUpdate != "function" || E === n.memoizedProps && $ === n.memoizedState || (r.flags |= 1024), r.memoizedProps = o, r.memoizedState = ge), m.props = o, m.state = ge, m.context = T, o = z) : (typeof m.componentDidUpdate != "function" || E === n.memoizedProps && $ === n.memoizedState || (r.flags |= 4), typeof m.getSnapshotBeforeUpdate != "function" || E === n.memoizedProps && $ === n.memoizedState || (r.flags |= 1024), o = !1);
    }
  ...
  var Ds = !1, xr = !1, uy = typeof WeakSet == "function" ? WeakSet : Set, he = null;
  function Eo(n, r) {
    var l = n.ref;
      ...
      if ("selectionStart" in n) var l = { start: n.selectionStart, end: n.selectionEnd };
        ...
        if (o && o.rangeCount !== 0) {
          ...
          t: for (; ; ) {
            ...
            for (; ; ) {
              if (X === n) break t;
              if ($ === l && ++z === c && (E = m), $ === d && ++W === o && (T = m), (fe = X.nextSibling) !== null) break;
              X = $, $ = X.parentNode;
            }
            X = fe;
          }
    ...
    switch (n.tag) {
      ...
      case 22:
        if (W = l !== null && l.memoizedState !== null, n.mode & 1 ? (xr = (z = xr) || W, ii(r, n), xr = z) : ii(r, n), ta(n), o & 8192) {
          if (z = n.memoizedState !== null, (n.stateNode.isHidden = z) && !W && n.mode & 1) for (he = n, W = n.child; W !== null; ) {
            for (X = he = W; he !== null; ) {
    ...
    for (var o = (n.mode & 1) !== 0; he !== null; ) {
      ...
      if (c.tag === 22 && o) {
        ...
        if (!m) {
          ...
          E = Ds;
          var z = xr;
          if (Ds = m, (xr = T) && !z) for (he = c; he !== null; ) m = he, T = m.child, m.tag === 22 && m.memoizedState !== null ? Pd(c) : T !== null ? (T.return = m, he = T) : Pd(c);
...
function ak() {
  return iT || (iT = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var te = 0, Z = 1, Te = 2, J = 3, pe = 4, G = 5, xe = 6, Ve = 7, it = 8, lt = 9, pt = 10, Ye = 11, Je = 12, ke = 13, tt = 14, He = 15, un = 16, Vt = 17, en = 18, on = 19, kt = 21, Ne = 22, Ht = 23, Dt = 24, Mt = 25, Re = !0, ne = !1, we = !1, ie = !1, _ = !1, P = !0, Ie = !0, Pe = !0, vt = !0, st = /* @__PURE__ */ new Set(), ut = {}, ct = {};
    function ht(e, t) {
      $t(e, t), $t(e + "Capture", t);
    }
    function $t(e, t) {
    ...
    function tn(e) {
      return br.call(Pt, e) ? !0 : br.call(ft, e) ? !1 : be.test(e) ? (Pt[e] = !0, !0) : (ft[e] = !0, S("Invalid attribute name: `%s`", e), !1);
    }
    function hn(e, t, a) {
...
Check the render method of \`` + e + "`." : "";
    ...
    function Dn(e, t, a, i, u, s, f) {
      ...
      if (r(p) ? v = d : Ps(p) ? m ? v = ge : (v = X, y = W) : $(p) && (v = fe), v) {
        var g = v(t, a);
        if (g) {
          vh(e, g, i, u);
          return;
    ...
    function w(e, t, a, i, u, s, f) {
      ...
      if (!(!v && !p)) {
        ...
        if (x !== M) {
          ...
          var O = null, K = $s(u);
          if (K === a) {
            var ve = new se(_e, wt + "enter", M, i, u);
...
`).replace(OT, "");
    ...
    function MT(e, t, a, i, u) {
      for (var s in i)
        if (i.hasOwnProperty(s)) {
          ...
          else s === Eh || s === ko || s === ME || (ut.hasOwnProperty(s) ? f != null && (typeof f != "function" && Th(s, f), s === "onScroll" && En("scroll", t)) : f != null && _r(t, s, f, u));
        }
    }
    function NT(e, t, a, i) {
    ...
    function jT(e, t, a, i, u) {
      ...
      for (v in f)
        if (!(p.hasOwnProperty(v) || !f.hasOwnProperty(v) || f[v] == null))
          ...
          } else v === np || v === Bs || v === Eh || v === ko || v === ME || (ut.hasOwnProperty(v) ? s || (s = []) : (s = s || []).push(v, null));
      for (v in p) {
    ...
    function Xy(e, t) {
      {
        ...
        switch (e.tag) {
          ...
          case G: {
            ...
            switch (t.tag) {
              case G: {
                var v = t.type, y = t.pendingProps, g = (e.mode & yt) !== Me;
                Qx(
                  s,
                  f,
                  p,
      ...
      if (i) {
        ...
        if (u !== null)
          switch (u.tag) {
            ...
            case G: {
              var p = u.type, v = u.memoizedProps, y = u.stateNode, g = (u.mode & yt) !== Me;
              Hx(
                p,
                v,
                y,
    ...
    function Bh(e) {
      ...
      return i0(e), e.tag === ke ? zi = m1(e) : zi = Ar ? op(e.stateNode) : null, !0;
    }
    function y1() {
      return rl && zi !== null;
    }
...
See https://reactjs.org/link/refs-must-have-owner for more information.`);
    ...
    function f0(e) {
      ...
      function v(D, H, O, K) {
        ...
        typeof ve == "object" && ve !== null && ve.$$typeof === qe && c0(ve) === H.type)) {
          var ce = u(H, O.props);
      ...
      function y(D, H, O, K) {
        if (H === null || H.tag !== pe || H.stateNode.containerInfo !== O.containerInfo || H.stateNode.implementation !== O.implementation) {
          var ve = tE(O, D.mode, K);
          return ve.return = D, ve;
        } else {
        ...
        if (typeof K == "object" && K !== null) {
          switch (K.$$typeof) {
            ...
            case qe:
              ...
              return M(D, H, O, jt(Jt), ve);
          }
          if (dt(K) || rt(K)) {
            var qn = D.get(O) || null;
            return g(H, qn, K, ve, null);
          }
          $h(H, K);
        }
      ...
      function se(D, H, O, K) {
          ...
          throw new Error("An object is not an iterable. This error is likely caused by a bug in React. Please file an issue.");
        {
          ...
          var ce = ve.call(O);
          if (ce)
            for (var $e = null, Ze = ce.next(); !Ze.done; Ze = ce.next()) {
              var Jt = Ze.value;
              $e = U(Jt, $e, D);
            }
        }
      ...
      function _e(D, H, O, K) {
        for (var ve = O.key, ce = H; ce !== null; ) {
          if (ce.key === ve) {
            ...
            // because hot reloading has different semantics than prod because
            // it doesn't resuspend. So we can't let the call below suspend.
            typeof $e == "object" && $e !== null && $e.$$typeof === qe && c0($e) === ce.type) {
              a(D, ce.sibling);
              var Jt = u(ce, O.props);
      ...
      function wt(D, H, O, K) {
        for (var ve = O.key, ce = H; ce !== null; ) {
          if (ce.key === ve)
            if (ce.tag === pe && ce.stateNode.containerInfo === O.containerInfo && ce.stateNode.implementation === O.implementation) {
              a(D, ce.sibling);
        ...
        do {
          ...
          if (_e = _e.next, _e === null) {
            if (p = u.shared.pending, p === null)
              break;
            var ve = p, ce = ve.next;
            ve.next = null, _e = ce, u.lastBaseUpdate = ve, u.shared.pending = null;
          }
        } while (!0);
    ...
    function zf(e) {
      e != null && !dt(e) && S("%s received a final argument that is not an array (instead, received `%s`). When specified, the final argument must be an array.", V, typeof e);
    }
    function H1(e) {
      {
        var t = Ge(Kt);
...
Incoming: %s`, V, "[" + t.join(", ") + "]", "[" + e.join(", ") + "]");
    ...
    function Uf(e, t, a, i, u, s) {
      ...
      (e.mode & yt) !== Me && S("Internal React error: Expected static flag was missing. Please notify the React team."), im = !1, v)
    ...
    function Ag(e, t, a) {
      ...
      return u |= Qi, (Kt.mode & Ut) !== Me && (u |= _l), bp(u, dr, z0.bind(null, t, e), i);
    }
    function pm(e, t, a) {
      typeof t != "function" && S("Expected useImperativeHandle() second argument to be a function that creates a handle. Instead received: %s.", t !== null ? typeof t : "null");
    ...
    var Fo = q.unstable_now, q0 = 0, Em = -1, kp = -1, Cm = -1, Ig = !1, Rm = !1;
    function X0() {
      return Ig;
    }
    function Y1() {
    ...
    function G1(e, t, a) {
      var i = e.stateNode;
      {
        ...
        // this one.
        (e.mode & Xt) === Me && (Dp.add(t), S(`%s uses the legacy childContextTypes API which is no longer supported and will be removed in the next major release. Use React.createContext() instead
...
.Learn more about this warning here: https://reactjs.org/link/legacy-context`, u)), t.contextTypes && !Dp.has(t) && // Strict Mode has its own warning for legacy context, so we can skip
        // this one.
        (e.mode & Xt) === Me && (Dp.add(t), S(`%s uses the legacy contextTypes API which is no longer supported and will be removed in the next major release. Use React.createContext() with static contextType instead.
...
` + ("" + y);
    ...
    function oS(e, t, a) {
      ...
      return f !== null && typeof f.componentDidCatch == "function" && (i.callback = function() {
        ...
        }), typeof u != "function" && (ea(e.lanes, Be) || S("%s: Error boundaries should implement getDerivedStateFromError(). In that method, return a state update to display an error message or fallback UI.", Ge(e) || "Unknown"));
      }), i;
    }
    function uC(e, t, a) {
      var i = e.pingCache, u;
...
Check the render method of \`` + i + "`.");
    ...
    function gC(e, t, a) {
      ...
      if (f || hw(u, e) ? (s = !0, t.flags &= ~De) : (e === null || e.memoizedState !== null) && (u = z1(u, w0)), u = Lf(u), Ao(t, u), e === null) {
        Zy(t);
    ...
    function Sw(e, t, a, i, u) {
      ...
      if (
        ...
        var g = t.child;
        y = g, y.childLanes = I, y.pendingProps = v, t.mode & zt && (y.actualDuration = 0, y.actualStartTime = -1, y.selfBaseDuration = f.selfBaseDuration, y.treeBaseDuration = f.treeBaseDuration), t.deletions = null;
      } else
    ...
    function Cw(e, t, a) {
      return (e.mode & yt) === Me ? (S("Cannot hydrate Suspense in legacy mode. Switch from ReactDOM.hydrate(element, container) to ReactDOMClient.hydrateRoot(container, <App />).render(element) or remove the Suspense components from the server rendered components."), e.lanes = Be) : Fy(t) ? e.lanes = Tr : e.lanes = Zr, null;
    }
    function Rw(e, t, a, i, u, s, f) {
      if (a)
        if (t.flags & Rr) {
          ...
          var H = i.children, O = i.fallback, K = Ew(e, t, H, O, f), ve = t.child;
...
Learn more about data fetching with Hooks: https://reactjs.org/link/hooks-data-fetching` : y = " You returned: " + p, S("%s must not return anything besides a function, which is used for clean-up.%s", v, y);
    ...
    function $w(e, t, a, i) {
      if ((a.flags & Ol) !== Le)
        switch (a.tag) {
          ...
          case Je: {
            {
              var M = a.memoizedProps, U = M.onCommit, F = M.onRender, se = a.stateNode.effectDuration, Ue = K0(), _e = t === null ? "mount" : "update";
              X0() && (_e = "nested-update"), typeof F == "function" && F(a.memoizedProps.id, _e, a.actualDuration, a.treeBaseDuration, a.actualStartTime, Ue);
              {
    ...
    function FC(e) {
      return e.tag === G || e.tag === J || e.tag === pe;
    }
    function HC(e) {
      var t = e;
      e: for (; ; ) {
        ...
        for (t.sibling.return = t.return, t = t.sibling; t.tag !== G && t.tag !== xe && t.tag !== en; ) {
          if (t.flags & yn || t.child === null || t.tag === pe)
            continue e;
          t.child.return = t, t = t.child;
        }
        if (!(t.flags & yn))
            ...
            if (p !== null) {
              ...
              if (v !== null) {
                ...
                do {
                  ...
                  x !== void 0 && ((M & Yl) !== Pa ? Dm(a, t, x) : (M & dr) !== Pa && (cs(a), a.mode & zt ? (ql(), Dm(a, t, x), Gl(a)) : Dm(a, t, x), xd())), g = g.next;
                } while (g !== y);
              }
            }
          }
      ...
      switch (e.tag) {
        ...
        case Ne: {
          ...
          if (Xl(e), u & zn) {
            ...
            if (H.isHidden = K, K && !Et && (ve.mode & yt) !== Me) {
              Ee = ve;
              for (var ce = ve.child; ce !== null; )
                Ee = ce, tb(ce), ce = ce.sibling;
            }
            Ww(ve, K);
          }
          return;
    ...
    function gr(e, t, a, i) {
      Xb(), JC && S("useInsertionEffect must not schedule updates."), jS && (zm = !0), So(e, a, i), (xt & Ir) !== I && e === Ea ? Zb(t) : (Jr && bs(e, t, a), e_(t), e === Ea && ((xt & Ir) === hr && (Hp = at(Hp, a)), yr === jp && Io(e, mr)), Ba(e, i), a === Be && xt === hr && (t.mode & yt) === Me && // Treat `act` as if it's inside `batchedUpdates`, even in legacy mode.
      ...
      BS = function(e, t, a) {
        ...
        try {
          ...
          if (c1() || s !== null && typeof s == "object" && typeof s.then == "function")
            throw s;
          if (Gh(), _0(), LC(e, t), ER(t, i), t.mode & zt && $g(t), bl(null, wC, null, e, t, a), Wi()) {
            var u = us();
...
Check the render method of \`` + y + "`.");
    ...
    function tE(e, t, a) {
      var i = e.children !== null ? e.children : [], u = oi(pe, i, e.key, t);
...
function lk(Y, q) {
  ...
  return Lt.useEffect(() => {
    ...
    return document.addEventListener("click", S), document.addEventListener("scroll", Ke, { passive: !0 }), () => {
      document.removeEventListener("click", S), document.removeEventListener("scroll", Ke), Oe.current && clearTimeout(Oe.current);
    };
...
function ok() {
  const [Y, q] = Lt.useState(!1), [A, et] = Lt.useState("chat"), [Qe, Oe] = Lt.useState(uk), [S, Ke] = Lt.useState(null);
  Lt.useEffect(() => {
    try {
  ...
  return {
    ...
    addMessage: J,
    currentRoutine: S,
    setCurrentRoutine: pe
  };
}
function sk() {
  const [Y, q] = Lt.useState("closed"), [A, et] = Lt.useState(null), [Qe, Oe] = Lt.useState([]), S = Lt.useCallback(() => {
    q("initializing");
  }, []), Ke = Lt.useCallback(() => {
    q("closed"), et(null), Oe([]);
  }, []), te = Lt.useCallback((pe) => {
    Oe((G) => [...G.filter((Ve) => Ve.category !== pe.category), pe]);
  }, []), Z = Lt.useCallback((pe) => {
    Oe((G) => G.filter((xe) => xe.category !== pe));
...
function ck({ routine: Y, onBack: q, primaryColor: A }) {
  ...
  if (!Y)
    return /* @__PURE__ */ ye.jsx("div", { style: { padding: "2rem", textAlign: "center", color: "var(--stella-text-secondary)" }, children: /* @__PURE__ */ ye.jsx("p", { children: "Loading your perfect routine..." }) });
  const Oe = Y.steps.length * 45;
  return /* @__PURE__ */ ye.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%", background: "transparent" }, children: [
    /* @__PURE__ */ ye.jsxs("div", { style: {
      ...
      /* @__PURE__ */ ye.jsx("button", { onClick: q, style: { background: "rgba(255,255,255,0.15)", border: "none", color: "white", cursor: "pointer", width: "32px", height: "32px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", transition: "background 0.2s" }, children: "←" }),
      /* @__PURE__ */ ye.jsxs("div", { children: [
        /* @__PURE__ */ ye.jsx("div", { style: { fontWeight: 700, fontSize: "15px" }, children: Y.name }),
        /* @__PURE__ */ ye.jsxs("div", { style: { fontSize: "12px", opacity: 0.8 }, children: [
          Y.steps.length,
          " Steps • ",
          Y.estimatedTime
        ] })
    ...
    /* @__PURE__ */ ye.jsxs("div", { className: "stella-scroll", style: { flex: 1, overflowY: "auto", padding: "1.5rem", display: "flex", flexDirection: "column", gap: "2rem" }, children: [
      /* @__PURE__ */ ye.jsx("p", { style: { color: "var(--stella-text-secondary)", fontSize: "0.875rem", margin: 0, lineHeight: 1.5 }, children: Y.description }),
      /* @__PURE__ */ ye.jsxs("div", { style: { position: "relative" }, children: [
        /* @__PURE__ */ ye.jsx("div", { style: { position: "absolute", left: "15px", top: "10px", bottom: "10px", width: "2px", background: "linear-gradient(to bottom, var(--stella-primary), rgba(139, 92, 246, 0.2))" } }),
        Y.steps.map((S, Ke) => {
          var Z, Te, J;
          let te = dE.foundation;
          return (((Z = S.product) == null ? void 0 : Z.category) === "primer" || S.name.toLowerCase().includes("prep")) && (te = dE.primer), S.name.toLowerCase().includes("set") && (te = dE.powder), /* @__PURE__ */ ye.jsxs("div", { style: { position: "relative", paddingLeft: "44px", marginBottom: Ke === Y.steps.length - 1 ? 0 : "2rem" }, children: [
            /* @__PURE__ */ ye.jsx("div", { style: {
              position: "absolute",
              left: "10px",
              top: "4px",
              width: "12px",
            ...
            /* @__PURE__ */ ye.jsxs("div", { style: { fontSize: "0.75rem", color: "var(--stella-primary)", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }, children: [
              "Step ",
              S.order,
              ": ",
              S.name
            ...
            /* @__PURE__ */ ye.jsxs("div", { style: {
              ...
              /* @__PURE__ */ ye.jsxs("div", { style: { display: "flex", gap: "1rem", marginBottom: "0.75rem" }, children: [
                /* @__PURE__ */ ye.jsx("div", { style: { width: "60px", height: "60px", borderRadius: "0.5rem", background: "white", padding: "4px", border: "1px solid #f1f5f9", display: "flex", alignItems: "center", justifyContent: "center" }, children: /* @__PURE__ */ ye.jsx("img", { src: te, alt: ((Te = S.product) == null ? void 0 : Te.name) || "Product", style: { maxWidth: "100%", maxHeight: "100%", objectFit: "contain" } }) }),
                /* @__PURE__ */ ye.jsxs("div", { children: [
                  /* @__PURE__ */ ye.jsx("div", { style: { fontWeight: 600, color: "var(--stella-text-primary)", fontSize: "0.875rem" }, children: ((J = S.product) == null ? void 0 : J.name) || "Recommended Product" }),
                  /* @__PURE__ */ ye.jsx("div", { style: { fontSize: "0.875rem", color: "var(--stella-text-secondary)", marginTop: "0.25rem" }, children: S.why })
                ] })
              ] }),
              /* @__PURE__ */ ye.jsxs("div", { style: { display: "flex", gap: "0.5rem" }, children: [
                /* @__PURE__ */ ye.jsx("span", { style: { fontSize: "0.75rem", background: "white", padding: "0.25rem 0.5rem", borderRadius: "1rem", border: "1px solid #e2e8f0", color: "var(--stella-text-secondary)" }, children: S.when }),
                /* @__PURE__ */ ye.jsx("span", { style: { fontSize: "0.75rem", background: "white", padding: "0.25rem 0.5rem", borderRadius: "1rem", border: "1px solid #e2e8f0", color: "var(--stella-text-secondary)" }, children: S.duration })
              ] })
            ] })
          ] }, S.id);
        })
    ...
    /* @__PURE__ */ ye.jsxs("div", { style: {
      ...
      /* @__PURE__ */ ye.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ ye.jsx("span", { children: et ? "✓ Added Successfully" : "Add Entire Routine to Cart" }),
            !et && /* @__PURE__ */ ye.jsxs("span", { children: [
              "$",
              Oe,
              ".00"
            ] })
      ...
      /* @__PURE__ */ ye.jsxs("div", { style: {
        ...
        /* @__PURE__ */ ye.jsx("div", { style: { fontSize: "0.875rem", fontWeight: 600, color: "var(--stella-primary)", marginBottom: "8px" }, children: "Never run out of your perfect shade" }),
        /* @__PURE__ */ ye.jsx("p", { style: { fontSize: "0.75rem", color: "var(--stella-text-secondary)", marginBottom: "12px", marginTop: 0 }, children: "Save this routine to your email and Stella will automatically remind you when it's time to restock based on your usage." }),
        /* @__PURE__ */ ye.jsxs("div", { style: { display: "flex", gap: "8px" }, children: [
          /* @__PURE__ */ ye.jsx(
            "input",
            {
              type: "email",
          ...
          /* @__PURE__ */ ye.jsx(
            ...
            {
              onClick: (S) => {
                const Ke = S.currentTarget, te = document.getElementById("stella-email-capture");
...
const fk = Lt.lazy(() => import("./CameraView-ClDmKLSb.js").then((Y) => ({ default: Y.CameraView })));
function dk({ shopDomain: Y, brandId: q, primaryColor: A }) {
  const { hesitation: et, setHesitation: Qe } = lk(), { isOpen: Oe, setIsOpen: S, toggleOpen: Ke, activeView: te, setActiveView: Z, messages: Te, addMessage: J, currentRoutine: pe, setCurrentRoutine: G } = ok(), { cameraState: xe, openCamera: Ve } = sk(), it = Lt.useRef(null);
  return Lt.useEffect(() => {
    var lt;
    Oe && te === "chat" && ((lt = it.current) == null || lt.scrollIntoView({ behavior: "smooth" }));
  }, [Te, Oe, te]), Lt.useEffect(() => {
    et === "shade_confusion" ? (S(!0), Z("chat"), J("assistant", "I notice you're comparing shades. Based on your profile, I can calculate the exact mathematical match. Would you like me to find your perfect shade and apply it in AR?"), Qe(null)) : et === "ingredient_hesitation" && (S(!0), Z("chat"), J("assistant", "I see you're checking the ingredients. This formula is 100% clean and non-comedogenic. Do you have any specific sensitivities I should double-check for you?"), Qe(null));
  }, [et, S, Z, J, Qe]), Lt.useEffect(() => {
    const lt = () => {
      S(!0), Z("routine"), G({
        id: "mock-123",
        shopperId: "123",
  ...
  }, [S, Z, G]), /* @__PURE__ */ ye.jsxs("div", { className: "stella-widget-container", style: { "--primary-color": A }, children: [
    Oe && /* @__PURE__ */ ye.jsx("div", { className: "stella-panel", children: te === "chat" ? /* @__PURE__ */ ye.jsxs(ye.Fragment, { children: [
      /* @__PURE__ */ ye.jsxs("div", { style: {
        background: "var(--stella-primary)",
        color: "white",
        padding: "1.25rem",
        ...
        /* @__PURE__ */ ye.jsxs("div", { style: { display: "flex", alignItems: "center", gap: "10px" }, children: [
          /* @__PURE__ */ ye.jsx("div", { style: {
            width: "32px",
            height: "32px",
            borderRadius: "50%",
          ...
          /* @__PURE__ */ ye.jsxs("div", { children: [
            /* @__PURE__ */ ye.jsx("div", { style: { fontWeight: 700, fontSize: "15px" }, children: "Stella" }),
            /* @__PURE__ */ ye.jsx("div", { style: { fontSize: "12px", opacity: 0.8 }, children: "Active now" })
          ] })
        ] }),
        /* @__PURE__ */ ye.jsx(
          "button",
      ...
      /* @__PURE__ */ ye.jsxs("div", { className: "stella-scroll", style: { flex: 1, padding: "1.5rem", overflowY: "auto", display: "flex", flexDirection: "column", gap: "1rem" }, children: [
        Te.map((lt, pt) => {
          var Ye;
          return /* @__PURE__ */ ye.jsxs("div", { style: { display: "flex", flexDirection: "column", alignSelf: lt.role === "assistant" ? "flex-start" : "flex-end", maxWidth: "85%" }, children: [
            /* @__PURE__ */ ye.jsx("div", { className: `stella-msg ${lt.role === "assistant" ? "stella-msg-assistant" : "stella-msg-user"}`, style: { maxWidth: "100%" }, children: lt.text }),
            lt.role === "assistant" && ((Ye = lt.metadata) == null ? void 0 : Ye.products) && lt.metadata.products.length > 0 && /* @__PURE__ */ ye.jsx("div", { style: { display: "flex", flexDirection: "column", gap: "0.5rem", marginTop: "0.5rem" }, children: lt.metadata.products.map((Je) => /* @__PURE__ */ ye.jsxs("div", { style: {
              background: "white",
              ...
              /* @__PURE__ */ ye.jsxs("div", { children: [
                /* @__PURE__ */ ye.jsx("div", { style: { fontSize: "0.75rem", fontWeight: 600, color: "var(--stella-text-primary)" }, children: Je.name }),
                /* @__PURE__ */ ye.jsxs("div", { style: { fontSize: "0.75rem", color: "var(--stella-text-secondary)" }, children: [
                  "$",
                  Je.price,
                  ".00"
                ] })
    ...
    /* @__PURE__ */ ye.jsxs("button", { className: `stella-fab ${Oe ? "" : "stella-fab-pulse"}`, onClick: Ke, children: [
      /* @__PURE__ */ ye.jsx("span", { style: { fontSize: "20px" }, children: "✨" }),
      Oe ? "Close" : "Stella"
    ] }),
    xe !== "closed" && /* @__PURE__ */ ye.jsx(Lt.Suspense, { fallback: /* @__PURE__ */ ye.jsx("div", { style: { position: "fixed", inset: 0, background: "black", zIndex: 9999 } }), children: /* @__PURE__ */ ye.jsx(fk, {}) })
  ] });
}
...
if (Zp) {
  ...
  mE(Zp).render(
    /* @__PURE__ */ ye.jsx(J_.StrictMode, { children: /* @__PURE__ */ ye.jsx(dk, { shopDomain: Y, brandId: q, primaryColor: A }) })
  );
}
export {
  J_ as R,
