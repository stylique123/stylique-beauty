import { r as l, j as e, u as g, R as h } from "./main-DHUT5JWj.js";
function f({ isScanning: r }) {
  ...
  return l.useEffect(() => {
    ...
    let i = 0;
    const d = setInterval(() => {
      i < o.length ? (t((a) => [...a.slice(-2), o[i]]), i++) : clearInterval(d);
    }, 450);
    return () => clearInterval(d);
  }, [r]), r ? /* @__PURE__ */ e.jsxs("div", { style: {
    position: "absolute",
    inset: 0,
    ...
    /* @__PURE__ */ e.jsx("div", { style: {
      ...
      alignItems: "center",
      gap: "0.25rem"
    }, children: n.map((o, i) => /* @__PURE__ */ e.jsxs("div", { style: {
      fontSize: "0.75rem",
      fontFamily: "monospace",
      color: "white",
      opacity: i === n.length - 1 ? 1 : 0.4,
...
function b() {
  const r = l.useRef(null), n = l.useRef(null), { cameraState: t, setCameraState: o, closeCamera: i, startScan: d, analysisResult: a } = g(), [c, p] = h.useState(null);
  l.useEffect(() => {
    async function u() {
      if (t === "initializing")
        try {
          ...
          n.current = s, r.current && (r.current.srcObject = s), p(null);
        } catch (s) {
  ...
  const x = () => {
    t === "initializing" && o("active");
  };
  return t === "closed" ? null : /* @__PURE__ */ e.jsxs("div", { style: {
    position: "fixed",
    top: 0,
    left: 0,
    right: 0,
    ...
    !c && /* @__PURE__ */ e.jsx(f, { isScanning: t === "scanning" }),
    /* @__PURE__ */ e.jsxs("div", { style: {
      position: "absolute",
      bottom: 0,
      left: 0,
      ...
      t === "initializing" && /* @__PURE__ */ e.jsx("div", { style: { color: "white", fontWeight: 500 }, children: "Initializing Camera..." }),
      (t === "initializing" || t === "active") && /* @__PURE__ */ e.jsx(
        "button",
        {
          onClick: () => {
            d();
      ...
      t === "complete" && a && /* @__PURE__ */ e.jsxs("div", { style: {
        ...
        /* @__PURE__ */ e.jsx(
          ...
          {
            onClick: () => {
              i(), window.dispatchEvent(new CustomEvent("stella-open-routine"));
            },
            style: {
              width: "100%",
              background: "var(--primary-color, #8b5cf6)",
